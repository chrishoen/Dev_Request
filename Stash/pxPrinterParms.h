...
class PrinterParms : public Ris::BaseCmdLineParms
{
public:
   ...
   // Thread enable flags.
   bool mGCodeCommEnable;
   bool mLcdGraphicsEnable;
   bool mControlEnable;
   bool mIsochEnable;
...
#ifdef _PXPRINTPARMS_CPP_
   PrinterParms gPrinterParms;
#else
   extern PrinterParms gPrinterParms;
#endif
