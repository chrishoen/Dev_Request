...
public:
   ...
   static const int   cRunRequestMsg     = 5;
   static const int   cRunResponseMsg    = 6;
   static const int   cDataMsg           = 7;
   static const int   cByteBlobMsg       = 8;
};
...
class RunRequestMsg : public BaseMsg
{
public:
...
class RunResponseMsg : public BaseMsg
{
public:
